...
int
gluInvertMatrix(const float m[], float invOut[])
{
    float inv[16], det;
    int i;
...
TestMat3X3(void)
{
    ...
    assert(MathNearlyEqual(mat1.A00, 10.0f) && MathNearlyEqual(mat1.A11, 10.0f)
           && MathNearlyEqual(mat1.A22, 10.0f));

    Mat3X3 mat2 = MathMat3X3Identity();
    MathMat3X3Addition(&mat1, &mat2);
    assert(MathNearlyEqual(mat1.A00, 11.0f) && MathNearlyEqual(mat1.A11, 11.0f)
           && MathNearlyEqual(mat1.A22, 11.0f));

    mat1 = MathMat3X3Identity();
    MathMat3X3ModulateByScalar(&mat1, 2.5f);
    Vec3D out = { 1.0f, 3.0f, 2.0f };
    MathMat3X3MultByVec3D(&mat1, &out);
    assert(MathNearlyEqual(out.X, 2.5f) && MathNearlyEqual(out.Y, 7.5f)
           && MathNearlyEqual(out.Z, 5.0f));
